  ...
  <div class="detailBox tcommonBox" >
    ...
    <header>
      ...
      <h2>
        ...
        <span v-if="detailObj.content">{{ getWordCount(detailObj.content) }} 字</span>
        ...
        const md = new MarkdownIt({
          ...
          highlight: (str, lang) => {
            if (lang && Prism.languages[lang]) {
              try {
                return Prism.highlight(str, Prism.languages[lang], lang); // 使用 Prism.js 高亮代码
              } catch (__) {}
            }
            return ''; // 如果没有匹配的语言，返回默认的代码块
          },
        });

        // 渲染 Markdown 内容
        this.detailObj.content = md.render(response.content || '');
      });
    },
    getWordCount(text) {
